...
# 单行JSON，旧格式
OLD_FORMAT_SINGLE_LINE_JSON = """[17:42:31] 2025-11-05 17:42:31.287 | INFO | ReviewEngine.nodes.summary_node:process_output:131 - 清理后的输出: {"paragraph_latest_state": "这是首次总结内容"}"""

# 多行JSON，旧格式
OLD_FORMAT_MULTILINE_JSON = [
    "[17:42:31] 2025-11-05 17:42:31.287 | INFO | ReviewEngine.nodes.summary_node:process_output:131 - 清理后的输出: {",
    "[17:42:31] \"paragraph_latest_state\": \"这是多行\\nJSON内容\"",
    "[17:42:31] }"
]

# 包含FirstSummaryNode的旧格式日志
OLD_FORMAT_FIRST_SUMMARY = """[17:42:31] 2025-11-05 17:42:31.287 | INFO | ReviewEngine.nodes.summary_node:process_output:131 - FirstSummaryNode 清理后的输出: {"paragraph_latest_state": "首次总结"}"""

# 包含ReflectionSummaryNode的旧格式日志
OLD_FORMAT_REFLECTION_SUMMARY = """[17:43:00] 2025-11-05 17:43:00.272 | INFO | ReviewEngine.nodes.summary_node:process_output:296 - ReflectionSummaryNode 清理后的输出: {"updated_paragraph_latest_state": "反思总结"}"""

# 旧格式，非目标节点（应该被忽略）
OLD_FORMAT_NON_TARGET = """[17:41:16] 2025-11-05 17:41:16.742 | INFO | ReviewEngine.nodes.report_structure_node:run:52 - 正在为查询生成报告结构"""


# ===== 新格式（loguru默认格式）=====

# 单行JSON，新格式
NEW_FORMAT_SINGLE_LINE_JSON = """2025-11-05 17:42:31.287 | INFO     | ReviewEngine.nodes.summary_node:process_output:131 - 清理后的输出: {"paragraph_latest_state": "这是首次总结内容"}"""

# 多行JSON，新格式
NEW_FORMAT_MULTILINE_JSON = [
    "2025-11-05 17:42:31.287 | INFO     | ReviewEngine.nodes.summary_node:process_output:131 - 清理后的输出: {",
    "2025-11-05 17:42:31.288 | INFO     | ReviewEngine.nodes.summary_node:process_output:132 - \"paragraph_latest_state\": \"这是多行\\nJSON内容\"",
    "2025-11-05 17:42:31.289 | INFO     | ReviewEngine.nodes.summary_node:process_output:133 - }"
]

# 包含FirstSummaryNode的新格式日志
NEW_FORMAT_FIRST_SUMMARY = """2025-11-05 17:42:31.287 | INFO     | ReviewEngine.nodes.summary_node:process_output:131 - FirstSummaryNode 清理后的输出: {"paragraph_latest_state": "首次总结"}"""

# 包含ReflectionSummaryNode的新格式日志
NEW_FORMAT_REFLECTION_SUMMARY = """2025-11-05 17:43:00.272 | INFO     | ReviewEngine.nodes.summary_node:process_output:296 - ReflectionSummaryNode 清理后的输出: {"updated_paragraph_latest_state": "反思总结"}"""

# 新格式，非目标节点（应该被忽略）
NEW_FORMAT_NON_TARGET = """2025-11-05 17:41:16.742 | INFO     | ReviewEngine.nodes.report_structure_node:run:52 - 正在为查询生成报告结构: 洛阳钼业预期股价变化"""
...
COMPLEX_JSON_WITH_UPDATED = [
    "2025-11-05 17:43:00.272 | INFO     | ReviewEngine.nodes.summary_node:process_output:296 - 清理后的输出: {",
    "2025-11-05 17:43:00.273 | INFO     | ReviewEngine.nodes.summary_node:process_output:297 - \"updated_paragraph_latest_state\": \"## 核心发现（更新版）\\n1. 这是更新后的内容\"",
    "2025-11-05 17:43:00.274 | INFO     | ReviewEngine.nodes.summary_node:process_output:298 - }"
]

# 只有paragraph_latest_state的JSON
COMPLEX_JSON_WITH_PARAGRAPH = [
    "2025-11-05 17:42:31.287 | INFO     | ReviewEngine.nodes.summary_node:process_output:131 - 清理后的输出: {",
    "2025-11-05 17:42:31.288 | INFO     | ReviewEngine.nodes.summary_node:process_output:132 - \"paragraph_latest_state\": \"## 核心发现概述\\n1. 这是首次总结内容\"",
    "2025-11-05 17:42:31.289 | INFO     | ReviewEngine.nodes.summary_node:process_output:133 - }"
]
...
# 不包含"清理后的输出"的行（应该被忽略）
LINE_WITHOUT_CLEAN_OUTPUT = """2025-11-05 17:42:31.287 | INFO     | ReviewEngine.nodes.summary_node:process_output:131 - JSON解析成功"""

# 包含"清理后的输出"但不是JSON格式
LINE_WITH_CLEAN_OUTPUT_NOT_JSON = """2025-11-05 17:42:31.287 | INFO     | ReviewEngine.nodes.summary_node:process_output:131 - 清理后的输出: 这不是JSON格式的内容"""
...
INVALID_JSON = [
    "2025-11-05 17:42:31.287 | INFO | ReviewEngine.nodes.summary_node:process_output:131 - 清理后的输出: {",
    "2025-11-05 17:42:31.288 | INFO | ReviewEngine.nodes.summary_node:process_output:132 - \"paragraph_latest_state\": \"缺少结束引号",
    "2025-11-05 17:42:31.289 | INFO | ReviewEngine.nodes.summary_node:process_output:133 - }"
]
...
MIXED_FORMAT_LINES = [
    "[17:42:31] 2025-11-05 17:42:31.287 | INFO | ReviewEngine.nodes.summary_node:process_output:131 - 清理后的输出: {",
    "2025-11-05 17:42:31.288 | INFO     | ReviewEngine.nodes.summary_node:process_output:132 - \"paragraph_latest_state\": \"混合格式内容\"",
    "[17:42:31] }"
]

# ===== 实际生产环境日志示例 =====

# TrendEngine反思总结 - 多行JSON格式
REAL_TREND_ENGINE_REFLECTION = [
    "[10:56:04] 2025-11-06 10:56:04.759 | INFO     | TrendEngine.nodes.summary_node:process_output:302 - 清理后的输出: {",
...
# ReviewEngine反思总结 - 多行JSON格式（包含"正在生成反思总结"标识）
REAL_REVIEW_ENGINE_REFLECTION = [
    "[10:55:19] 2025-11-06 10:55:19.563 | INFO     | ReviewEngine.nodes.summary_node:run:265 - 正在生成反思总结",
    "[10:56:41] 2025-11-06 10:56:41.626 | INFO     | ReviewEngine.nodes.summary_node:process_output:296 - 清理后的输出: {",
...
SEARCH_NODE_REFLECTION_SEARCH = """[11:17:05] 2025-11-06 11:17:05.547 | INFO     | ReviewEngine.nodes.search_node:process_output:232 - 清理后的输出: {"search_query": "AI教育 数据泄露 不公平", "search_tool": "search_hot_content", "reasoning": "需要了解近期关于AI教育的热点争议，特别是公众最关心的数据安全和公平性问题，以补充具体案例和真实舆情数据", "time_period": "week", "enable_sentiment": true}"""

# ===== 错误日志示例（应该被过滤，不应进入论坛）=====

# SummaryNode的JSON解析失败错误日志
SUMMARY_NODE_JSON_ERROR = "[11:55:31] 2025-11-06 11:55:31.763 | ERROR    | CompetitorEngine.nodes.summary_node:process_output:141 - JSON解析失败: Unterminated string starting at: line 1 column 28 (char 27)"

# SummaryNode的JSON修复失败错误日志
SUMMARY_NODE_JSON_FIX_ERROR = "[11:55:31] 2025-11-06 11:55:31.799 | ERROR    | CompetitorEngine.nodes.summary_node:process_output:149 - JSON修复失败，直接使用清理后的文本"

# SummaryNode的ERROR级别日志（包含nodes.summary_node但不应被捕获）
SUMMARY_NODE_ERROR_LOG = "[11:55:31] 2025-11-06 11:55:31.763 | ERROR    | CompetitorEngine.nodes.summary_node:process_output:141 - 发生错误：无法处理输出"

# SummaryNode的Traceback错误日志（虽然包含nodes.summary_node，但不应被捕获）
SUMMARY_NODE_TRACEBACK = """[11:55:31] File "D:\\Programing\\DA\\SingleEngineApp\\..\\CompetitorEngine\\nodes\\summary_node.py", line 138, in process_output
