...
KEYWORDS = "国安,LPL,瓜迪奥拉,影之刃,申花,EDG.M,章子怡,朱一龙,Angelababy,台风,肖战,丁禹兮,乌克兰,嫦娥七号,美股,A股,宇树科技,iPhone 17,影之刃零,大学生外卖,90后首富,AI电影,糖尿病,泔水喂猪,MoneyPrinterTurbo,华为Mate90,iQOO Neo11,空枪,赵晓哲,BIGBANG新歌,兰州拉面,BIGBANG,哈佛医学院,OpenViking,朱雀三号,韩国股市,蓝箭航天,王星案,DeepSeek,民政局,伊朗,冒名上大学,AI,厄尔尼诺,王者荣耀,大司马,火影手游,曼城,马晓春,黑色素瘤"  # 关键词搜索配置，以英文逗号分隔
...
CUSTOM_BROWSER_PATH = "/Applications/Microsoft Edge.app/Contents/MacOS/Microsoft Edge"
