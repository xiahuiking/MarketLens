...
-- 为MediaCrawler现有表添加话题关联字段，支持SentinelSpider功能
...
-- 设置合适的字符集和排序规则
-- ALTER DATABASE sentinel_spider CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
