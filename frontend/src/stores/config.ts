...
export const useConfigStore = defineStore('config', () => {
  ...
  const groups: ConfigGroupDef[] = [
    ...
    {
      title: '口碑 Agent (ReviewEngine)',
      subtitle: 'Review Engine LLM Settings',
      fields: [
        { key: 'REVIEW_ENGINE_API_KEY', label: 'API Key', type: 'password' },
        { key: 'REVIEW_ENGINE_BASE_URL', label: 'Base URL', type: 'text' },
        { key: 'REVIEW_ENGINE_MODEL_NAME', label: '模型名称', type: 'text' },
      ],
    },
    {
      title: '竞品 Agent (CompetitorEngine)',
      subtitle: 'Competitor Engine LLM Settings',
      fields: [
        { key: 'COMPETITOR_ENGINE_API_KEY', label: 'API Key', type: 'password' },
        { key: 'COMPETITOR_ENGINE_BASE_URL', label: 'Base URL', type: 'text' },
        { key: 'COMPETITOR_ENGINE_MODEL_NAME', label: '模型名称', type: 'text' },
      ],
    },
    {
      title: '趋势 Agent (TrendEngine)',
      subtitle: 'Trend Engine LLM Settings',
      fields: [
        { key: 'TREND_ENGINE_API_KEY', label: 'API Key', type: 'password' },
        { key: 'TREND_ENGINE_BASE_URL', label: 'Base URL', type: 'text' },
        { key: 'TREND_ENGINE_MODEL_NAME', label: '模型名称', type: 'text' },
      ],
    },
    {
